<template>
    <div class="purple flex flex-col min-h-screen">
        ...
        <div class="flex-auto flex flex-col sm:flex-row justify-center px-8">
          <!--LoginForm es el componente LoginForm de vue y v-on es una directiva
          que se usa para escuchar eventos por ejemplo cuando se emita el evento user-authenticated
            usado en el loginForm cuando la respuesta sea OK se ejecutara el metodo onUserAuthenticated-->
            <LoginForm
